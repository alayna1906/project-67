...
**If you like the app,** rate it from 1 star upto 5 stars.

**If you're a mental health professional,** audit [the descriptions](https://github.com/Flaque/quirk/blob/master/src/locals/en.json) of the cognitive distortions. If you have suggestions, to improve the app for our users, let me know and we'll change stuff!

**If you can draw** and can make digital illustrations of the little blobs, feel free to approach us and I'll find a place to stick them in the app!
